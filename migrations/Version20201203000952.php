 ...
 */
final class Version20201203000952 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE referentiel ADD programme LONGBLOB DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE referentiel DROP programme');
    }
}
